...
#SBATCH --output=logs/train_sigmorphon_2017_bilstm_attn_inflector.%j.log
...
readonly ARCH=lstm
readonly RESULTS_PATH="${ROOT}/results/${PARTITION}/bi${ARCH}-attn"
...
readonly TRAIN="${DATA}/train/${PARTITION}/${LANGUAGE}-train-medium"
