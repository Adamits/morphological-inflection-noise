...
#SBATCH --output=logs/pretrain_finetune_transformer_inflector.%j.log
...
readonly RESULTS_PATH="${ROOT}/results/${PARTITION}-pretrain-finetune/${K}/${ARCH}"
...
readonly NUM_PRETRAIN_EPOCHS=200
...
readonly PRETRAIN_WARMUP_STEPS=1000
...
yoyodyne-train \
  ...
  --pretrain-warmup-steps "${PRETRAIN_WARMUP_STEPS}" \
