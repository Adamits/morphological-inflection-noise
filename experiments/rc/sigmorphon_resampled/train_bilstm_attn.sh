...
#SBATCH --output=logs/train_sigmorphon_resampled_bilstm_attn_inflector.%j.log
...
readonly ARCH=lstm
readonly RESULTS_PATH="${ROOT}/results/${PARTITION}/bi${ARCH}-attn-sigmorphon-resampled"
