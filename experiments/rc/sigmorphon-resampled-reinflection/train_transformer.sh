...
#SBATCH --output=logs/train_sigmorphon_resampled-reinflection_transformer_inflector.%j.log
...
readonly RESULTS_PATH="${ROOT}/results/${PARTITION}/${K}/${ARCH}-sigmorphon-resampled-reinflection"
