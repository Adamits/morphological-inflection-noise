...
#SBATCH --output=logs/train_sigmorphon_resampled-reinflection_bilstm_attn_inflector.%j.log
...
readonly ARCH=lstm
readonly RESULTS_PATH="${ROOT}/results/${PARTITION}/${K}/bi${ARCH}-attn-sigmorphon-resampled-reinflection"
